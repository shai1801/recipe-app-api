...
def create_user(email='user@example', password='password123'):
    """Create and return a user"""
    return get_user_model().objects.create_user(email=email, password=password)


class PublicTagApiTests(TestCase):
    """Test for unauthenticated API Requestss"""
...
class PrivateTagApiTests(TestCase):
    ...
    def test_filter_assigned_to_recipes(self):
        """Test listing tags to those assigned to ricpes."""
    ...
    def test_filtered_tags_filtered(self):
